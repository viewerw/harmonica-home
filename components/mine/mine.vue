    ...
    <div class="cu-list menu sm-border">
      <!-- <div v-if="!isReview" class="cu-item arrow">
        ...
        >
          ...
          <text class="text-grey" :class="{ badge: hasNewMessage }"
            >我的消息</text
          >
        </navigator>
      </div> -->
      <div class="cu-item arrow margin-bottom">
        <navigator
          class="content"
          hover-class="none"
          url="/pages/tonal-modification/index"
          open-type="navigate"
        >
      ...
      <div v-if="!isReview" class="cu-item arrow" @click="joinGroup">
        <div class="content">
...
export default {
  ...
  methods: {
    ...
    joinGroup() {
      wx.previewImage({
        current: this.QQGroupImage,
        urls: [this.QQGroupImage, this.wxGroupImage],
      });
    },
  },
  ...
  async mounted() {
    ...
    this.QQGroupImage = data.QQGroupImage;
  },
};
</script>
